...
<main class="w-[350px] min-h-[200px] max-h-[500px] overflow-y-auto bg-white dark:bg-gray-900">
  ...
  <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
    <span class="text-sm font-semibold text-gray-900 dark:text-gray-100">TimeWarden</span>
  ...
  {:else if error}
    <div class="flex flex-col items-center justify-center py-12 gap-2" role="alert">
  ...
  {:else}
      ...
      <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
        {#if currentStatus.isBlocked}
          <div class="text-center py-2">
            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{currentStatus.domain}</div>
            <div class="text-lg font-bold text-red-600 dark:text-red-400 mt-1" role="alert">BLOCKED</div>
            <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Time limit reached for today</div>
          </div>
        {:else}
    ...
    {:else}
      <div class="px-4 py-4 border-b border-gray-200 dark:border-gray-700 text-center">
    ...
    {:else}
      <div class="px-4 py-4 text-center">
        <span class="text-xs text-gray-400 dark:text-gray-500">No domains configured yet.</span>
        <button
          type="button"
          class="block mx-auto mt-2 text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
          onclick={openSettings}
        >
          Open Settings
        </button>
